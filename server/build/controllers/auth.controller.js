...
exports.updatePassword = exports.logoutUser = exports.loginUser = exports.registerUser = void 0;
...
const loginUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const passAuth = yield bcryptjs_1.default.compare(password, user.password);
        if (!passAuth) {
            res.status(400).json({ message: "You Entered Wrong Login Credentials" });
            return;
        }
        const { password: loginPassword } = user, userDetails = __rest(user, ["password"]);
