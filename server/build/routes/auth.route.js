...
const verifyPassStrength_1 = __importDefault(
  require("../middleware/verifyPassStrength"),
);
const verifyUserInformation_1 = __importDefault(
  require("../middleware/verifyUserInformation"),
);
const checkEmailAndUsernameReuse_1 = __importDefault(
  require("../middleware/checkEmailAndUsernameReuse"),
);
